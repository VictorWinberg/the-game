...
export default class EasterEggs {
	...
	setKonamiCode() {
		...
		this.konamiCode.label = new THREE.Mesh(
			...
			new THREE.MeshBasicMaterial({ transparent: true, depthWrite: false, color: 0xffffff, alphaMap: this.konamiCode.labelTexture })
		)
	...
	setWigs() {
		...
		// List
		this.wigs.list = [this.resources.items.wig1, this.resources.items.wig2, this.resources.items.wig3, this.resources.items.wig4]
		...
		this.wigs.areaLabel = new THREE.Mesh(
			...
			new THREE.MeshBasicMaterial({ transparent: true, depthWrite: false, color: 0xffffff, alphaMap: this.resources.items.areaQuestionMarkTexture })
		)
	...
	setEggs() {
		...
		const eggOptions = [
			{
				offset: new THREE.Vector3(-29.8, -18.94, 0.5),

...
export default class Zone extends EventEmitter {
	constructor(_options) {
		...
		// Mesh
		this.mesh = new THREE.Mesh(new THREE.BoxGeometry(_options.halfExtents.x * 2, _options.halfExtents.y * 2, 3, 1, 1, 1), new THREE.MeshBasicMaterial({ color: 0xff00ff, wireframe: true }))
